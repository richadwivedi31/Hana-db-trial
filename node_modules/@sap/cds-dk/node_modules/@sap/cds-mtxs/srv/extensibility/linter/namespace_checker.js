module.exports = class NamespaceChecker {
  ...
  _checkElement(element, parent, elementPrefixes, compileDir, warnings) {
    ...
    warnings.push(this._createPrefixWarning(element, parent, elementPrefixes))
  }

  _checkEntity(element, reflectedCsn, reflectedFullCsn, elementPrefixes, compileDir, warnings) {
    if (elementPrefixes.length < 1) {
      return
    }
    ...
    warnings.push(this._createPrefixWarning(element, parentFromFullCsn, elementPrefixes))
  }
  ...
  _checkNamespace(element, namespaceBlacklist, compileDir, warnings) {
