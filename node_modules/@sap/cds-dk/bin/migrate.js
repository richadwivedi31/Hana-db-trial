module.exports = Object.assign(migrate, {
    ...
    shortcuts: ['-d'],
    flags: ['--dry', '--force', '--cleanup', '--resolve-bindings'],
    help: `
# SYNOPSIS

    *cds migrate* <tenant1|"*">[,<tenant2>] [-d <directory>] [--tag <tag>] [--tagRule <tag rule>] [--dry] [--force]
...
# OPTIONS
    ...
    *-d* | *--directory* <extension-projects-directory>
        ...
        Specify the target directory of your migrated extension projects. By default, the migrated extension projects will not be stored.

    *--tag* <tag>

        Specify a default tag that is to be used to store the extension. If not specified "migrated" will be used.

    *--tagRule* <tag rule>

        Specify a regular expression that describes the mapping from file names to tags, e. g. "extension-(.*)\.cds" to map from "extension-123.cds" to tag "123". If the expression does not match, the default tag will be used.
