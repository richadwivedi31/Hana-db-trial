...
# SYNOPSIS
    ...
    *cds -e* <code snippet>
    ...
    Evaluates and executes the given JavaScript code snippet. The snippet can refer
    to the already loaded *cds* variable. If it starts with a '.', 'cds' is
    automatically  prepended, like shown in the following examples.
...
function run ([code]) {
  ...
  const outcome = eval(code) //NOSONAR
  console.log (outcome)
}
